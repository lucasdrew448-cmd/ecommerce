        ...
        <form onSubmit={handleSubmit} className="grid gap-4">
          ...
          <div className="grid gap-2">
            ...
            <input
              ...
              className="w-full min-w-0 max-w-full rounded-lg border border-slate-300 px-3 py-2 text-sm file:mr-3 file:rounded-full file:border-0 file:bg-blue-50 file:px-3 file:py-1 file:text-xs file:font-semibold file:text-blue-700 disabled:opacity-50 sm:text-base sm:file:text-sm"
            />
          </div>

          {form.image_url ? (
            <div className="overflow-hidden rounded-xl border border-slate-200">
              <img src={form.image_url} alt="Product main image preview" className="h-40 w-full object-cover sm:h-48" />
            </div>
          ) : null}
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            ...
            <button
              ...
              className="w-full rounded-full border border-slate-300 px-4 py-2 font-semibold text-slate-700 sm:w-auto"
            >
              Reset
            </button>
          </div>
          ...
          {products.map((product) => (
            <article key={product.id} className="rounded-2xl border border-slate-200 p-4">
              ...
              <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:flex-wrap">
                <button type="button" onClick={() => startEditing(product)} className="w-full rounded-full border border-slate-300 px-3 py-2 text-sm font-semibold text-slate-700 sm:w-auto">
                  Edit
                </button>
                <button type="button" onClick={() => handleDelete(product)} className="w-full rounded-full border border-rose-200 px-3 py-2 text-sm font-semibold text-rose-700 sm:w-auto">
                  Delete
                </button>
              </div>
            </article>
